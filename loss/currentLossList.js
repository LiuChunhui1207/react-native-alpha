...
module.exports = class currentLossList extends SComponent {
    static propTypes = {
        ...
        >
            <View style={s.row_item}>
                <Row>
                    ...
                    <SText style={[s.width70, {marginRight: 5, marginLeft: 10},]} fontSize="body"
                           color="333">{rowData.centerhouseLossRate}</SText>
        ...
        return (
            <View style={{flex: 1}}>
                ...
                <View style={[s.row, s.header]}>
                    ...
                    <TouchableOpacity activeOpacity={1} onPress={() => {
                        ...
                        if (this.state.cloumn2TypeDESC) {
                            this._sortDataDESC('centerhouseLossRateIndex');
                        } else {
                            this._sortDataASC('centerhouseLossRateIndex');
                        }
                        this.changeState({
                    ...
                    <TouchableOpacity activeOpacity={1} onPress={() => {
                        ...
                        if (this.state.cloumn1TypeDESC) {
                            this._sortDataDESC('refundRateIndex');
                        } else {
                            this._sortDataASC('refundRateIndex');
                        }
                        this.changeState({
                ...
                <View style={s.butom}>
                    ...
                    <SText style={{marginRight: 15}} fontSize="mini"
                           color="blue">{this.state.totalLossRate ? this.state.totalLossRate : 0}</SText>
                </View>
