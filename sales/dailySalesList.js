...
module.exports = class dailySalesList extends SComponent{
    static propTypes = {
        ...
        return (
            <View style={{flex: 1}}>
                ...
                <View style={s.butom} >
                    ...
                    <SText style={s.buttomText} fontSize="mini" color="blue">{this.state.totalSalesNum||0}件</SText>
                    <SText style={s.buttomText} fontSize="mini" color="blue" >{this.state.totalSalesFee?this.state.totalSalesNum :0}元</SText>
                </View>
            </View>
        )
    }
