...
module.exports = class profitRatedailyList extends SComponent{
    static propTypes = {
        ...
        return (
            <View style={{flex: 1}}>
                ...
                <View style={s.butom}>
                    ...
                    <SText style={s.buttomText} fontSize="mini" color="blue">{this.state.totalProfitFee?this.state.totalProfitFee:0}</SText>
                    <SText style={s.buttomText} fontSize="mini" color="blue">{this.state.totalProfitRate?this.state.totalProfitRate:0}</SText>
                </View>
            </View>
        )
    }
